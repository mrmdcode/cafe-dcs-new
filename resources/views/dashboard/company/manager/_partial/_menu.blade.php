    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu " data-simplebar>
        <ul class="menu-inner">
            <li class="menu-item open">
                <a href="{{ route('company.manager.dashboard') }}"
                    class="menu-link @if (Route::current()->getName() == 'company.manager.dashboard') active @endif">
                    داشبورد
                </a>
            </li>
            <li class="menu-item open">
                <a href="{{ route('company.employee.index') }}"
                    class="menu-link @if (Route::current()->getName() == 'company.employee.index') active @endif">
                    پرسنل
                </a>
            </li>
            <li class="menu-item open">
                <a href="{{ route('company.template') }}"
                    class="menu-link @if (Route::current()->getName() == 'company.template') active @endif">
                    شخصی سازی صفحه اصلی </a>
            </li>
            <li class="menu-item open">
                <a href="{{ route('company.category.index') }}"
            ...
            <li class="menu-item open">
                <a href="{{ route('company.printer.index') }}"
                    class="menu-link @if (Route::current()->getName() == 'companies.index') active @endif">
                    پرینتر ها
                </a>
            </li>
            ...
            <li class="menu-item open">
                <a href="{{ route('company.table.index') }}"
                    class="menu-link @if (Route::current()->getName() == 'companies.index') active @endif">
                    میز
                </a>
            </li>
        ...
        <div class="d-flex align-items-center admin-info border-top">
            <div class="flex-shrink-0">
                <a href="{{ route('home') }}" class="d-block">
                    <img src="{{ asset('/storage/' . auth()->user()->company->image) }}" class="rounded-circle wh-54"
                        alt="admin">
